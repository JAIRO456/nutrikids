...
class MYPDF extends TCPDF {
	...
	// Colored table
	public function ColoredTable($header,$sqlUsuarios) {
		...
		foreach($sqlUsuarios as $row) {
            ...
            $this->Cell($w[4], 6, $row['rol'], 'LR', 0, 'L', $fill);
...
// column titles
$header = array('Documento', 'Nombres', 'Apellidos', 'Correo', 'Rol', 'Estado');

// data loading
// $data = $pdf->LoadData('data/table_data_demo.txt');

// print colored table
$pdf->ColoredTable($header, $sqlUsuarios);
