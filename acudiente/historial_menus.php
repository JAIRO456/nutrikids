<?php
    ...
    $sqlHistory = $con -> prepare('SELECT DISTINCT menus.id_menu, estudiantes.nombre, estudiantes.apellido, menus.nombre_menu, menus.precio, GROUP_CONCAT(DISTINCT producto.nombre_prod) as productos, estados.estado FROM pedidos
    ...
    GROUP BY menus.id_menu, estudiantes.nombre, estudiantes.apellido, menus.nombre_menu, menus.precio, estados.estado');
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($pagos AS $pago): ?>
                            <tr>
                                <td><?php echo $pago['nombre_menu']; ?></td>
                                <td><?php echo $pago['precio']; ?></td>
                                <td><?php echo $pago['productos']; ?></td>
