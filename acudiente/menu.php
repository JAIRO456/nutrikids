...
<nav class="menu">
    <div class="menu-container">
        <a class="logo" href="#">
            <img src="../img/logo-nutrikids2.png" width="30" height="30" alt="Logo">
            <span>NUTRIKIDS</span>
        </a>
        ...
        <div class="menu-content">
            <ul class="menu-list">
                ...
                <li class="dropdown">
                    <a href="#" onclick="toggleDropdown('categorias')"><i class="fa-solid fa-list"></i> Categorías</a>
                    <div class="dropdown-content" id="categorias">
                        <a href="categorias.php">Categorías</a>
                        <?php foreach ($Categories as $Category) { ?>
                            <a href="productos.php?id_categoria=<?= $Category['id_categoria'] ?>"><?= $Category['categoria'] ?></a>
                        <?php } ?>
                    </div>
                </li>
                <li><a href="horarios.php"><i class="fa-solid fa-clock"></i> Horarios</a></li>
                <li><a href="asignacion.php"><i class="fa-solid fa-user-plus"></i> Asignación</a></li>
                <li class="dropdown">
                    <a href="#" onclick="toggleDropdown('historial')"><i class="fa-solid fa-history"></i> Historial</a>
                    <div class="dropdown-content" id="historial">
                        <a href="historial_pagos.php">Historial de Pagos</a>
                        <a href="historial_menus.php">Historial de Menús</a>
                    </div>
                </li>
            </ul>
