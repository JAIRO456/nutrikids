<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($sqlUpdate->execute([$nombre_escuela, $telefono, $email, $fileName, $id_escuela])) {
            echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showModal('Escuela actualizada exitosamente.', 'success');
                            setTimeout(() => {
            ...
            echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showModal('Error al actualizar la escuela.', 'error');
                        });
                    </script>";
        }
    }
    ...
    <main class="container-main">
        <div class="form-container">
            ...
            <form id="form" class="form" action="" method="POST" enctype="multipart/form-data">
                <div class="x_grupo" id="x_nombre_escuela">
                ...
                <div class="x_grupo" id="x_email_esc">
                ...
                <div class="x_grupo" id="x_telefono_esc">
