    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($sqlInsertProduct->execute([$id_producto, $nombre_prod, $descripcion, $precio, $fileName, $id_categoria, $id_marca])) {
            ...
            if ($sqlInsertInfoNutricional->execute([$id_producto, $calorias, $proteinas, $carbohidratos, $grasas, $azucares, $sodio])) {
                echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showModal('Producto creado exitosamente.', 'success');
                            setTimeout(() => {
                ...
                echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showModal('Error al crear la información nutricional del Producto.', 'error');
                        });
                    </script>";
            }
        } 
            ...
            echo "<script>
                    document.addEventListener('DOMContentLoaded', function() {
                        showModal('Error al crear el Producto.', 'error');
                    });
                </script>";
        }
    }
